...
def policy(root: Path, *, max_seconds: int | None = None) -> dict[str, Any]:
    ...
    if config_path.is_file():
        ...
        # The indexer is also used for isolated/ad-hoc repositories in tests,
        # graph tooling, and recovery commands. Missing project configuration
        # means "use bounded defaults"; malformed existing configuration is
