...
eval:
	uv run --project .ai/runtime python .ai/evals/run.py --axis precall_routing --axis context_budget --axis tool_discovery --axis autoresearch_retrieval --axis code_retrieval --axis line_span_retrieval --axis memory_retrieval --wired --strict --require-complete
