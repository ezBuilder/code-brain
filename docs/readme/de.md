...
Code Brain ist repo-lokale Infrastruktur für ernsthafte KI-Coding-Agents. Es gibt Claude Code, Codex CLI, Google Antigravity und Kiro dasselbe Projektgedächtnis, dieselbe BM25-Codesuche, Hook-Policy, denselben Audit-Trail und Upgrade-Pfad innerhalb eines Workspace; die MCP-Exposition bleibt hostspezifisch.
